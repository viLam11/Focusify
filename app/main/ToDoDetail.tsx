...
export default function ToDoDetail() {
    ...
    return (
        <View className='flex-1 bg-gray-200 w-full'>
            <ScrollView className='flex-1 w-11/12 mx-auto'>
                ...
                <View className="flex flex-row justify-between items-center mt-4">
                    <View className="w-1/2">
                        <View className="w-11/12 bg-white h-28 rounded-lg items-center flex flex-col">
                        ...
                        <View className="w-11/12 mt-4 bg-white h-28 rounded-lg items-center flex flex-col">
                            <View className='h-3/4 flex items-center justify-center '>
